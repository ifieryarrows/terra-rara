...
def test_known_good_overlay_includes_batch_size_fallback():
    ...
    assert updated.weekly_loss.lambda_magnitude == 0.60
    assert updated.weekly_loss.lambda_naive == 0.40
    assert updated.weekly_loss.lambda_bias == 0.21
    assert updated.weekly_loss.lambda_directional == 0.05
...
def test_weekly_loss_defaults_use_structural_monotonic_recovery_terms():
    ...
    assert cfg.weekly_loss.lambda_magnitude == 0.60
    assert cfg.weekly_loss.lambda_naive == 0.40
    assert cfg.weekly_loss.lambda_bias == 0.21
    assert cfg.weekly_loss.lambda_directional == 0.05
