...
def test_weekly_metrics_report_flipped_direction_worse_for_aligned_predictions():
    actual = np.array(
        [
            [0.020, 0.000, 0.000, 0.000, 0.000],
            [-0.030, 0.000, 0.000, 0.000, 0.000],
    ...
    assert metrics["weekly_directional_accuracy"] == 1.0
    assert metrics["weekly_directional_accuracy_flipped"] == 0.0
    assert metrics["weekly_tail_capture_rate"] == 1.0
    assert metrics["weekly_tail_capture_rate_flipped"] == 0.0
    assert metrics["weekly_sharpe_ratio"] > metrics["weekly_sharpe_ratio_flipped"]
    assert metrics["weekly_sign_correlation"] > 0.99
