...
class Settings(BaseSettings):
    ...
    openrouter_model_scoring_reliable: Optional[str] = "qwen/qwen3-next-80b-a3b-instruct:free"
    openrouter_model_commentary: str = "qwen/qwen3-next-80b-a3b-instruct:free"
