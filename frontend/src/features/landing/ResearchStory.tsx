...
const chapters = [
  { id: 'market', number: '01', label: 'THE MARKET', title: 'Start with the bigger picture.', text: 'See copper in context before focusing on a single forecast.', tags: ['Market heatmap', 'Related instruments'], link: 'Explore market context', to: '/dashboard#market-map', Preview: MarketPreview },
  { id: 'news', number: '02', label: 'THE CONTEXT', title: 'See the signal behind the story.', text: 'Watch a headline become tone, impact and rationale.', tags: ['Tone scoring', 'LLM rationale'], link: 'Read the intelligence', to: '/dashboard#news-intelligence', Preview: NewsPreview },
  { id: 'forecast', number: '03', label: 'THE POSSIBILITIES', title: 'See the range. Keep the uncertainty.', text: 'See the forecast range alongside the last close.', tags: ['Deep-learning forecasts', 'Price & risk context'], link: 'Examine the forecasts', to: '/dashboard#price-forecast', Preview: ForecastPreview },
];
